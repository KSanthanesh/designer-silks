...
class TestViews(TestCase):
    ...
    def test_product_detail_page(self):
        """ If the user click products then product_detail page will appear"""
        category = Category.objects.create(
            name='chiffon_saree', friendly_name='Chiffon Saree')
        product = Product.objects.create(
            category='chiffon', sku='12345', name='kavi', price='45',
            rating='4', material='chiffon', description='chiffon',
            length='5.5m', image='image.jpg'
        )
